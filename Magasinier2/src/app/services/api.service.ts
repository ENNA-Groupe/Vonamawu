...
export class ApiService {
  ...
  getAll() {
    this.http.get<any[]>(this.url + 'data/magasinierMaison/' + this.user.id, this.options).subscribe(
      (res) => {
        console.log(res);
  ...
  login(data: any) {
    return new Promise(
      (resolve, reject) => {
        this.http.post<any>(this.url + 'magasinierMaisonLogin', data, this.options).subscribe(
          (res: any) => {
  ...
  logout(data: any) {
    return new Promise(
      (resolve, reject) => {
        this.http.post<any>(this.url + 'magasinierLogout', data, this.options).subscribe(
          (res: any) => {
            this.alert.toast({ type: res.type, message: res.message });
  ...
  getData() {
    ...
    this.getRoute('data', 'magasinierMaison/' + this.user.id + '/' + this.dataService.lastId).subscribe(
      (res: any) => {
        console.log(res);
